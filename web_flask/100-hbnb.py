...
Update 8-places.css to always have the price by night on the top right of each
place element,& the name correctly aligned and visible (i.e. screenshots below)
